...
CREATE TABLE `permission` (
  ...
  `add_book` tinyint(1) NOT NULL,
  `update_book` tinyint(1) NOT NULL,
  `delete_book` tinyint(1) NOT NULL,
  `create_manager` tinyint(1) NOT NULL,
  `update_manager` tinyint(1) NOT NULL,
  `delete_manager` tinyint(1) NOT NULL,
...
-- Dump completed on 2024-12-01 18:37:32
